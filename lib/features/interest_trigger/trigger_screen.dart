                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text('No notifications yet',
                                style:
                                    TextStyle(color: AppColors.mediumGrey)),
                          ],
                        ),
                      )
                    : ListView.separated(
          ...
          actions: [
            ...
            ElevatedButton(
              onPressed: () {
                ...
                if (existing != null) {
                  manager.editRule(existing.copyWith(
                    targetOPR: opr,
                    equipmentType: selectedEquipment,
                  ));
                } else {
                  manager.addRule(TriggerRule(
                ...
                manager.checkTriggers(
                    _currentOPR, _selectedYear.round());
              },
